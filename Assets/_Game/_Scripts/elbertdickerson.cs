...
public class elbertdickerson : MonoBehaviour, IUnityAdsInitializationListener, IUnityAdsLoadListener, IUnityAdsShowListener
{

    public string sharihammond;
    public GameObject marilynlucero;

    #region AdMob
    [Header("Admob")]
    public string heidishearer = "";
    public string virgiehathaway = "";
    public string alexandrawilkins = "";

    #endregion
    [Space(15)]
    #region
    [Header("UnityAds")]
    public string effierivas;
    public string unityAdsVideoPlacementId = "rewardedVideo";
    #endregion

    static elbertdickerson instance;

    public static int unlockID;
 
    public static elbertdickerson Instance
    {
        get
        {
            if (instance == null)
                instance = GameObject.FindObjectOfType(typeof(elbertdickerson)) as elbertdickerson;
