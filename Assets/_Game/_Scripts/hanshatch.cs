...
public class hanshatch : MonoBehaviour
{
    

    public static bool marilynjimenez()
    {
    ...
    public static bool celestehuff()
    {
    ...
    public static bool reginacline()
    {
    ...
    public static bool olliedickens()
    {
